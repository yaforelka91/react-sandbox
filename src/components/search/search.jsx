  ...
  return (
    <div className="container">
      ...
      <h1>
        ...
        и ценителей{' '}
        <span role="img" aria-label="Omelette">
          🍳
        </span>
      </h1>
      <p>
        Все любят поесть. Поэтому почему бы не поискать рецепт какого-нибудь блюда? Так как запрос идет к англоязычному
        ресурсу, то придется уметь в английский (или просто отправить пустую строку!) За предоставленное API благодарим{' '}
        <a href="http://www.recipepuppy.com/" target="_blank" rel="noopener noreferrer">
          Recipe Puppy
        </a>
      </p>
      <p>Для запросов к API используется Axios, вывод результата происходит после нажатия кнопки отправки.</p>
      <form
      ...
      >
        <div className="search-form__wrapper">
          <label className="visually-hidden" htmlFor="recipe">
        ...
        <button className="btn search-form__confirm" type="submit">
          Искать
        </button>
      </form>
